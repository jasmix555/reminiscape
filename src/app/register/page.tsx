    ...
    <div className="container mx-auto max-w-md p-6">
      ...
      {!isConfirming ? (
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          <h1 className="text-center text-3xl font-bold">Get Started with the App</h1>
          <p className="text-center text-sm">Please enter a valid email address.</p>
          ...
          <button
            ...
            className={`flex w-full items-center justify-center gap-2 rounded border border-gray-300 py-2 font-bold text-gray-700 transition ${
        ...
        <div className="text-center">
          <p className="mb-4 text-green-600">
            A confirmation email has been sent to {email}. Please check your inbox to activate your
            account.
          </p>
          <button className="text-blue-500 underline" onClick={handleResendVerification}>
            Resend
          </button>
          {timer !== null && (
